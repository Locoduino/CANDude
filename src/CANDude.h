...
class CANDudeSettings
{
  ...
  private : uint32_t mBaudRate;   // asked baud rate in byte/s
...
class CANDudeSendMessage {
  ...
  private : const uint8_t * const start() const { return &sidh; }
  private : const uint8_t * const dataPart() const { return data; }
